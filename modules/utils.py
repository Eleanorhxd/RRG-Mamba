...
def parse_args():
    ...
    parser.add_argument('--cfg', type=str, required=True, metavar="FILE", default='/root/autodl-fs/RG/CAMANet-main/configs/swin_tiny_patch4_window7_224.yaml', help='path to config file', )
    parser.add_argument(
        "--opts",
    ...
    parser.add_argument('--pretrained', default='/root/autodl-fs/imagenet21k_ViT-B_32.npz',
    ...
    # Data input settings
    parser.add_argument('--data_dir', type=str, default='/root/autodl-fs',# iu /root/autodl-fs
    ...
    parser.add_argument('--beam_size', type=int, default=3, help='the beam size when beam searching.') #3
    ...
    parser.add_argument('--img_size', type=int, default=224, help='the image size for ViT construction.') #224
